...
namespace ZombieLand
{
	...
	public static class PatchGroups
	{
		...
		static readonly HashSet<string> ContaminationPatchTypes = new()
		{
			...
			"ZombieLand.ContaminationStorageSettings_AllowedToAccept_Patch",
			"ZombieLand.ContaminationStorageSettings_CopyFrom_Patch",
			"ZombieLand.ContaminationStorageSettings_DefaultConstructor_Patch",
